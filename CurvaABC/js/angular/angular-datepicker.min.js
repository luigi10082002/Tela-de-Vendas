...
(function withAngular(angular, navigator) {
  ...
  var A_DAY_IN_MILLISECONDS = 86400000
    ...
    , generateDaysColumns = function generateDaysColumns() {
      ...
      return [
      '<div class="_720kb-datepicker-calendar-days-header" style="padding: 0 !important;">',
    ...
    , datepickerDirective = function datepickerDirective($window, $compile, $locale, $filter, $interpolate) {
      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        $scope.nextMonth = function nextMonth() {
          ...
          //set next month
          $scope.month = translateMonth($filter('date')(new Date($scope.year, $scope.monthNumber - 1), 'MM'));
          //reinit days
          setDaysInMonth($scope.monthNumber, $scope.year);
        ...
        $scope.month = translateMonth($filter('date')(date, 'MM')); //$filter('date')(date, 'MMMM');//december-November like
        $scope.monthNumber = Number($filter('date')(date, 'MM')); // 01-12 like
        $scope.day = Number($filter('date')(date, 'dd')); //01-31 like
        if ($scope.dateMaxLimit) {
        ...
        //$scope.months = ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"];
        $scope.daysInString = ["Dom", "Seg", "Ter", "Qua", "Qui", "Sex", "Sab"];
        ...
        function translateMonth (monthNumber) {
        	return $scope.months[monthNumber - 1];
        }
